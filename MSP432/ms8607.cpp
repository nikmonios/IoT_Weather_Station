...
ms8607::ms8607(void): psensor_conversion_time{ PSENSOR_CONVERSION_TIME_OSR_256,  PSENSOR_CONVERSION_TIME_OSR_512, PSENSOR_CONVERSION_TIME_OSR_1024, PSENSOR_CONVERSION_TIME_OSR_2048, PSENSOR_CONVERSION_TIME_OSR_4096, PSENSOR_CONVERSION_TIME_OSR_8192} 
{
 ...
 */
enum ms8607_status
ms8607::get_compensated_humidity(float temperature, float relative_humidity, float *compensated_humidity) 
{
 ...
 */
enum ms8607_status
ms8607::psensor_read_pressure_and_temperature(float *temperature, float *pressure) 
{
  enum ms8607_status status = ms8607_status_ok;
